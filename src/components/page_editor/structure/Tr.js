...
class Tr extends Component {
  ...
  componentWillReceive = (nextProps) => {
    if(nextProps.page) {
      this.setState({
        ...
        _parentId: this.props.page._parentId,
        children: this.props.page.children,
        name: {
          value: this.props.page.name.value,
          url: this.props.page.name.url
        },
        type: {
          value: this.props.page.type.value,
          url: this.props.page.type.url
        },
        state: this.props.page.state,
        lastModified: this.props.page.lastModified,
        actions: {
          pageSettingsUrl: this.props.page.actions.pageSettings.url,
          selectTypeUrl: this.props.page.actions.selectType.url,
          copySettingsToSinglePageUrl: this.props.page.actions.copySettingsToSinglePage.url,
          addPagesUrl: this.props.page.actions.addPages.url,
          editSubStructureUrl: this.props.page.actions.editSubStructure.url,
          arrangeChildrenUrl: this.props.page.actions.arrangeChildren.url,
          movePageUrl: this.props.page.actions.movePage.url,
          duplicatePageUrl: this.props.page.actions.duplicatePage.url,
          importPagesUrl: this.props.page.actions.importPages.url,
          deletePageUrl: this.props.page.actions.deletePage.url
        },
        currentTrId: null
      })
    }  
  ...
  render() {
    ...
    return(        
      <tr id={_id} onClick={this.handleCollapse.bind(this, _id)} data-tt-id={""+_id+""} data-tt-parent-id={""+dataTTPrentId+""} className={classnames({children: children })} >
